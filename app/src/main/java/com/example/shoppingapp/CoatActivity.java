...
public class CoatActivity extends AppCompatActivity  implements LoaderManager.LoaderCallbacks<Cursor> {
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clothesname.setText("Coats");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CoatActivity.this, SummaryActivity.class);
        ...
        minus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int Price = 100;
                if (quantity == 0) {
                    Toast.makeText(CoatActivity.this, "Cant decrease quantity < 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int price = Price * quantity;
