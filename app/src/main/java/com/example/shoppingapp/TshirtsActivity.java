...
public class TshirtsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clothesname.setText("Tshirt");
        imageView.setImageResource(R.drawable.tshirts);

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TshirtsActivity.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int basePrice = 100;
                if (quantity == 0) {
                    Toast.makeText(TshirtsActivity.this, "Cant decrease quantity < 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
